...
{
	//_classpath.push_back(new ClasspathDirectory(std::string("../lib"), std::string("*.jar"), false));

	_classpath.push_back(new ClasspathSingle(std::string("../lib/bootstrap.jar")));
	_classpath.push_back(new ClasspathSingle(std::string("../lib/util.jar")));
	_classpath.push_back(new ClasspathSingle(std::string("../lib/jdom.jar")));
	_classpath.push_back(new ClasspathSingle(std::string("../lib/log4j.jar")));
	_classpath.push_back(new ClasspathSingle(std::string("../lib/extensions.jar")));
	_classpath.push_back(new ClasspathSingle(std::string("../lib/trove4j.jar")));
	_classpath.push_back(new ClasspathSingle(std::string("../lib/jna.jar")));

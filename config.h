...
#define EXE_MAKER_ERROR_TEXT "Not find valid JDK. Please set IDEA_JDK variable, or download it.(Ok - go to site, Cancel - close)"

#define EXE_MAKER_DOWNLOAD_URL "http://java.com"

#define EXE_MAKER_ERROR_CAPTION "Idea Startup Error"

#ifdef WIN32
#define EXE_MAKER_VM_PROPERTIES "idea.exe.vmoptions"
#elif WIN64
#define EXE_MAKER_VM_PROPERTIES "idea64.exe.vmoptions"
#endif
...
#define EXE_MAKER_APP_ID L"org.intellij.idea"